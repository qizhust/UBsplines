function [bkps_new,blss] = bk_4(img, directions, non_max_threshold, line_threshold)
...
if(nargin~=4)
	error('Four argument is required.');
end
[rows,cols] = size(img);
...
[blss,bd_th] = blap_ss_4(img,sigman,O,directions,sigma0);
